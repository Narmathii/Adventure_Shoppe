...
class AccessListController extends BaseController
{
    ...
    public function insertProducts()
    {
        ...
        if (!$validation->withRequest($this->request)->run()) {
            ...
            if ($affectedRows) {
                ...
                $oldData = $db->query($oldDataQry, [$lastInsertedID])->getResultArray();
    ...
    a.search_brand,a.weight,a.weight_units,a.quantity,a.specifications,
    CASE 
...
";
        ...
        $spreadsheet = new Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
        $filename = 'Ptoduct_StockDetails.xlsx';
