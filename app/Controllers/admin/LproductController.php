...
use App\Models\admin\LugproductModal;
...
class LproductController extends BaseController
{

    public function productList()
    {
        $db = \Config\Database::connect();
        $res['menu'] = $db->query('SELECT `lug_menu`,`lug_menu_id`FROM `tbl_luggage_menu` WHERE `flag`= 1')->getResultArray();
        ...
        if ($session->get('login_sts') == "") {
            ...
            return view("admin/lugProducts", $res);
        }
    ...
    public function insertProduct()
    {
        ...
        $modal = new LugproductModal;
        $configg = new ProdConfigModel;
        $db = \Config\Database::connect();
        $data = $this->request->getPost();

        $data['tbl_name'] = "tbl_luggagee_products";
    ...
    public function updateProduct()
    {
        ...
        $query = "SELECT product_img,img_1,img_2,img_3,img_4,img_5,img_6,img_7,img_8,img_9,img_10 FROM `tbl_luggagee_products` WHERE `flag` = 1 AND `prod_id` = ? ";
        ...
        $data = [
            ...
            'tbl_name' => 'tbl_luggagee_products',
    ...
    public function getsubmenu()
    {
        ...
        $query = 'SELECT `lug_submenu_id`, `lug_submenu` FROM `tbl_luggage_submenu` WHERE `lug_menu_id` =? AND flag = 1';
    ...
    public function deleteProduct()
    {
        ...
        $query = 'UPDATE `tbl_luggagee_products` SET `flag` = 0 WHERE `prod_id` =?';
    ...
    public function exportLuggageStock()
    {
        ini_set('memory_limit', '1024M');
        ...
        $filename = 'Luggage_and_touring_stocks.xlsx';
