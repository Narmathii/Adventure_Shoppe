...
$routes->get('products/(:any)', 'Home::products/$1/$1');
$routes->get('motor-accessories/(:any)', 'Home::accessories/$1/$1');
$routes->get('accessories-detail/(:any)', 'Home::accessoriesDetail/$1/$1');
$routes->get('riding-accessories/(:any)', 'Home::ridingAccessories/$1/$1');
$routes->get('riding-details/(:any)', 'Home::ridingDetails/$1/$1');
$routes->get('tour-detail/(:any)', 'Home::tourDetails/$1');
$routes->get('helmet-accessories/(:any)', 'Home::helmetAccessories/$1/$1');
$routes->get('helmet-details/(:any)', 'Home::helmetDetails/$1/$1');
$routes->get('touring-accesssories/(:any)', 'Home::touringAccessories/$1');
$routes->get('offers', 'Home::offers');
$routes->get('tracking-order/(:any)', 'Home::trackingOrder/$1');
$routes->post('cancel-orders', 'Home::cancelOrders');
...
//tally Details
$routes->post('crm-to-tally', 'TallyController::getTallyData');
...
$routes->get('camping-products/(:any)', 'Home::campingProducts/$1/$1');
...
$routes->post('update-default-addr', 'CartController::updateDefaultAddr');
$routes->post('assign-couriercharge', 'CartController::assignCharges');
$routes->post('get-dist', 'CartController::getDist');

$routes->get('myprofile', 'UserController::myprofile');

$routes->get('address', 'UserController::address');
$routes->post('getdist-data', 'AddressController::getDist');
$routes->post('insert-address', 'AddressController::insertAddress');
$routes->get('get-address', 'AddressController::getAddress');
$routes->post('update-address', 'AddressController::updateAddress');
$routes->post('delete-address', 'AddressController::deleteAddress');

$routes->get('get-profile', 'UserController::getprofile');
$routes->post('update-profile', 'UserController::updateprofile');
$routes->post('cart-checkout', 'CartCheckoutController::cartCheckout');
$routes->get('check-userlogin', 'CartCheckoutController::checkLoginRes');
$routes->get('check-address', 'CartCheckoutController::checkAddress');

$routes->get('place-order', 'CartCheckoutController::placeOrder');

// RazerpayController checkout controller
$routes->get('payment', 'RazerpayController::payment');
...
$routes->get('successpage', 'Home::successpage');
$routes->get('failurepage', 'Home::failurepage');
...
$routes->get('ordersummary', 'Home::ordersummary');
$routes->get('newrrival-view', 'Home::newArrivalViewall');

$routes->get('helmet-view', 'Home::helmetView');
$routes->get('search-filter', 'Home::searchfiltrView');
$routes->post('search-data', 'SearchController::searchData');
$routes->get('terms-conditions', 'Home::terms');
$routes->get('privacy-policies', 'Home::policies');
$routes->get('myorders', 'Home::myorders');

$routes->get('hotsale', 'Home::hotsale');
$routes->post('get-suggession', 'SearchController::getSuggession');
$routes->post('prod-filter', 'SearchController::prodFilter');
$routes->post('bike-prod-filter', 'SearchController::BikeProdFilter');

$routes->post('offers-filter', 'SearchController::offersFilter');
$routes->post('newarrival-filter', 'SearchController::newArrivalFilter');
$routes->post('hotsale-filter', 'SearchController::hotsaleFilter');
...
$routes->post('buynow-products', 'BuynowController::buyProductsList');
$routes->post('buynow-checkout', 'BuynowController::buynowCheckout');

$routes->post('couriercharge-buynow', 'BuynowController::courierCharge');
...
$routes->get("get-sizemaster", "VarientController::getSizeMaster");

$routes->post("get-config-details", "admin\ProductController::getConfigColor");

$routes->post("get-varients", "VarientController::getVarients");
