...
<body>
                        ...
                        <div class="card custom-card">
                            <div class="card-header">
                                <a id="addData"
                                    ...
                                    Products &nbsp;&nbsp;<i class="bi bi-plus-square-fill"></i></a>
                                <!-- <a href="<?= base_url() ?>export-riding-stock"
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <span class="error text-danger r_menu_id mt-5"></span>
                                </div>
                                <div class="col-lg-6">
                                    <label for="r_sub_id" class="form-label">SubMenu
                                    </label><br>
                                    <select class="form-select" name="r_sub_id" id="r_sub_id">

                                        <!-- Menu -->
                                    </select>
                                    <span class="error text-danger r_sub_id mt-5"></span>
                                </div>
                                ...
                                <div class="col-lg-4 mt-3">
                                    ...
                                    <input type="text" class="form-control offer_price" id="offer_price"
                                        placeholder="Product Price" name="offer_price" value="">
                                ...
                                <div class="col-lg-3 mt-3">
                                    <label for="img_2" class="form-label">Image 2<span class="text text-success">(1080 x
                                            1440px)</span>
                                    </label><br>
    ...
    <script src="<?php echo base_url() ?>assets/admin/js/ridingProduct.js"></script>
