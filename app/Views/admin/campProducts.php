...
<body>
                        ...
                        <div class="card custom-card">
                            <div class="card-header">
                                <a id="addData"
                                    ...
                                    Products</a>
                                <!-- <a href="<?= base_url() ?>export-camp-stock"
                    ...
                    <form id="product-main">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <label for="c_submenu_id" class="form-label">SubMenu
                                    </label><br>
                                    <select class="form-select" name="c_submenu_id" id="c_submenu_id">
    ...
    <script src="<?php echo base_url() ?>assets/admin/js/campingProduct.js"></script>
</body>
