...
<body>
                    ...
                    <div class="ms-md-1 ms-0">
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item"><a href="#">Helmet & Accessories</a></li>
                        ...
                        <div class="card custom-card">
                            <div class="card-header">
                                <a id="addData"
                                    ...
                                    Products</a>
                                <!-- <a href="<?= base_url() ?>export-helmet-stock"
                    ...
                    <form id="product-main">
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <label for="h_submenu_id" class="form-label">SubMenu
                                    </label><br>
                                    <select class="form-select" name="h_submenu_id" id="h_submenu_id">

                                        <!--Sub Menu -->
                                    </select>
                                    <span class="error text-danger h_submenu_id mt-5"></span>
                                </div>
    ...
    <script src="<?php echo base_url() ?>assets/admin/js/helmetProduct.js"></script>
</body>
