                            ...
                            <?php for ($j = 0; $j < count($modal); $j++) {
                                if ($modal[$j]['brand_id'] === $brand[$i]['brand_id']) { ?>
                                    <ul class="submenu__list">
                                        <li>
                                            <a
                                                href="<?php echo base_url('products/' . strtolower(str_replace([' ', '/'], '-', $modal[$j]['modal_name'])) . '/' . base64_encode($modal[$j]['modal_id'])); ?>">
                        ...
                        <div class="submenu__inner">
                            ...
                            <?php for ($j = 0; $j < count($riding_submenu); $j++) {
                                if ($riding_submenu[$j]['r_menu_id'] === $riding_menu[$i]['r_menu_id']) { ?>
                                    <ul class="submenu__list">
                                        <li><a
                                                href="<?php echo base_url() ?>riding-accessories/<?php echo strtolower(str_replace(' ', '-', $riding_submenu[$j]['r_sub_menu'])) ?>/<?php echo base64_encode($riding_submenu[$j]['r_sub_id']) ?>">
                        ...
                        <div class="submenu__inner">
                            ...
                            <?php for ($j = 0; $j < count($h_submenu); $j++) {
                                if ($h_submenu[$j]['h_menu_id'] === $h_menu[$i]['h_menu_id']) { ?>
                                    <ul class="submenu__list">
                                        <li><a
                                                href="<?php echo base_url() ?>helmet-accessories/<?php echo strtolower(str_replace(' ', '-', $h_submenu[$j]['h_submenu'])) ?>/<?php echo base64_encode($h_submenu[$j]['h_submenu_id']) ?>">
                        ...
                        <div class="submenu__inner">
                            ...
                            <?php for ($j = 0; $j < count($lud_submenu); $j++) {
                                if ($lud_submenu[$j]['lug_menu_id'] === $lug_menu[$i]['lug_menu_id']) { ?>
                                    <ul class="submenu__list">
                                        <li><a
                                                href="<?php echo base_url() ?>touring-accesssories/<?php echo strtolower(str_replace(' ', '-', $lud_submenu[$j]['lug_submenu'])) ?>/<?php echo base64_encode($lud_submenu[$j]['lug_submenu_id']) ?>">
                        ...
                        <div class="submenu__inner">
                            ...
                            <?php for ($j = 0; $j < count($camp_submenu); $j++) {
                                if ($camp_submenu[$j]['camp_menuid'] === $camp_menu[$i]['camp_menu_id']) { ?>
                                    <ul class="submenu__list">
                                        <li><a
                                                href="<?php echo base_url() ?>camping-products/<?php echo strtolower(str_replace(' ', '-', $camp_submenu[$j]['c_submenu'])) ?>/<?php echo base64_encode($camp_submenu[$j]['c_submenu_id']) ?>">
