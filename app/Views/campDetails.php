                                ...
                                <form name="contactForm" id='product-form' method="post">
                                    ...
                                    <div class='row'>
                                        ...
                                        <!-- <input type="hidden" name="color" id="color_val"
                                            ...
                                            value="<?php echo $prod_details['size'][0] ?>" />
                                            ...
                                            <div class="col-lg-12">
                                                <p class="offer_price">
                                                    ...
                                                    if ($offerType == 0 || $offerType == 1) { ?>
                                                        <span
                                                            class="m-0 price_span">₹<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $prod_details['offer_price']) ?></span><span
                                                            class="real_price strike">
                                                            ₹<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $prod_details['product_price']); ?></span>
                                                        <?php
                                                    } else { ?>
                                                        <span
                                                            class="m-0 price_span">₹<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $prod_details['offer_price']) ?></span></span>
                                    ...
                                    <!-- For Quantity Update -->
                                    <input type="hidden" class="main-stock" value="<?= $prod_details['quantity'] ?>" data-sizeval="<?= $countSize ?>">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="tab-default">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                        ...
                                        <p class="m-0"><?php echo $prod_details['prod_desc'] ?></p>
                                    </div>
                            ...
                            <div class="tab-default mt-3">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                        aria-labelledby="nav-home-tab">
                                        <p class="m-0"><?php echo $prod_details['specifications'] ?></p>
                                    </div>
