                ...
                <table class="mt-4">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="text-align:right"><?= $data[0]['courier_charge'] ?></td>
                        </tr>
                        <tr>
                            <td colspan="4" style="text-align:right">Total Price : </td>
                            <td colspan="2" style="text-align:right"><?= $data[0]['sub_total'] ?></td>
                        </tr>
