    ...
    <div class="no-bottom no-top zebra">
            ...
            <div class="container">
                <div class="row">
                    <h2 class="text-center">
                        <?php echo $access_list[0]['sub_access_name'] ?>
                    </h2>
                    <!-- mobile view filter -->
                    ...
                    <div class="col-lg-9">
                        <div class="row seach_results">
                            ...
                            <?php } else { ?>
                                <?php for ($i = 0; $i < count($access_list); $i++) { ?>
                                    <div class="col-12 col-lg-4 productCard">
                                        <form>

                                            <div class="de-item mb30">
                                                <?php
                                                $offer = $access_list[$i]['offer_details'];
                                                ...
                                                <span class="offer  <?= $offerClass ?>">
                                                    <?= $access_list[$i]['offer_details'] ?>%
                                                </span>
                                                <!-- wishlist  start -->
                                                <a><span aria-hidden="true" class="icon_heart_alt wishlist-icon"
                                                        data-id="<?php echo $access_list[$i]['prod_id'] ?>"
                                                        tbl-name="<?php echo $access_list[$i]['tbl_name'] ?>"></span></a>
                                                <!-- wishlist end -->
                                                <div class="d-img">
                                                    <a
                                                        href="<?php echo base_url() ?>accessories-detail/<?php echo strtolower(str_replace(['/', ' '], '-', $access_list[$i]['redirect_url'])) ?>/<?php echo base64_encode($access_list[$i]['prod_id']) ?>">
                                                        <img
                                                            src="<?php echo base_url() ?>/<?php echo $access_list[$i]['product_img'] ?>" />
                                                    </a>
                                                </div>
                                                <div class="d-info product-details">
                                                    <div class="d-text">
                                                        <?php
                                                        $MRP = $access_list[$i]['product_price'];
                                                        $RS = $access_list[$i]['offer_price'];
                                                        ...
                                                        ?>
                                                        <span class="d-price">
                                                            ₹<?php echo number_format($access_list[$i]['offer_price']) ?>
                                                            &nbsp;<small class="<?= $Classname ?>"
                                                                style="text-decoration:line-through">₹<?php echo number_format($access_list[$i]['product_price']) ?></small>
                                                        </span>
                                                        <h4>
                                                            <?php echo $access_list[$i]['product_name'] ?>
                                                        </h4>
                                                        ...
                                                        if ($stock <= 0) { ?>
                                                            ...
                                                            <div>
                                                                <a class="btn-main buynow_btn"
                                                                    href="https://wa.me/7358992528?text=<?php echo urlencode("Product Information!\nProduct Name: " . $access_list[$i]['product_name'] . "\nProduct Price: " . $access_list[$i]['product_price']); ?>">Contact
                                                                    us to order</a>
                                                            </div>
                                                        ...
                                                        <?php } else { ?>
                                                            ...
                                                            <div>
                                                                <a class="btn-main buynow_btn"
                                                                    href="<?php echo base_url() ?>accessories-detail/<?php echo strtolower(str_replace(['/', ' '], '-', $access_list[$i]['redirect_url'])) ?>/<?php echo base64_encode($access_list[$i]['prod_id']) ?>">Buy
                                                                    Now</a>
                                                            </div>
                                                        <?php } ?>
                                ...
                                for (let i = 0; i < count; i++) {
                                    ...
                                    if (stock <= 0) {
                                        ...
                                        buyNow += `
                                                    <div>
                                                        <a class="btn-main buynow_btn"
                                                            href="${base_Url}accessories-detail/${product.redirect_url.toLowerCase().replace(/[/ ]/g, '-')}/${btoa(product.prod_id)}">
                                                            Buy Now
                                                        </a>
                                                    </div>
                                                `;
                              ...
                              <a><span aria-hidden="true" class="icon_heart_alt wishlist-icon"
                                ...
                                <div class="d-img">
                                 <a href="${base_Url}accessories-detail/${redirectUrl}/${prodId}">
                                    <img src="${base_Url}${product.product_img}" /></a>
                                </div>
                                <div class="d-info">
                                    <div class="d-text">
                                     <span class="d-price">
        ...
        <script>
            $(document).on('click', '.view-more', function () {
                ...
                $.ajax({
                    method: 'POST',
                    url: base_Url + 'loadmore-accessdetails',
