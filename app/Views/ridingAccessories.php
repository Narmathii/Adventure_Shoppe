    ...
    <div class="no-bottom no-top zebra">
                                    ...
                                    <div class="col-12 col-lg-4 productCard">
                                        <form>
                                            ...
                                            <div class="de-item mb30">
                                                <?php
                                                $offer = $r_accessories[$i]['offer_details'];
                                                ...
                                                <span class="offer  <?= $offerClass ?>">
                                                    <?= $r_accessories[$i]['offer_details'] ?>%
                                                </span>
                                                <!-- wishlist  start -->
                                                <a><span aria-hidden="true" class="icon_heart_alt wishlist-icon"
                                                        data-id="<?php echo $r_accessories[$i]['prod_id'] ?>"
                                                        tbl-name="<?php echo $r_accessories[$i]['tbl_name'] ?>"></span></a>
                                                <!-- wishlist end -->

                                                <div class="d-img">
                                                    <a
                                                        href="<?php echo base_url() ?>riding-details/<?php echo strtolower(str_replace(['/', ' '], '-', $r_accessories[$i]['redirect_url'])) ?>/<?php echo base64_encode($r_accessories[$i]['prod_id']) ?>"><img
                                                            src="<?php echo base_url() ?>/<?php echo $r_accessories[$i]['product_img'] ?>" />
                                                </div> </a>
                                                <div class="d-info">
                                                    <div class="d-text">
                                                        <?php
                                                        $MRP = $r_accessories[$i]['product_price'];
                                                        $RS = $r_accessories[$i]['offer_price'];
                                                        ...
                                                        ?>
                                                        <span class="d-price">
                                                            ₹<?php echo number_format($r_accessories[$i]['offer_price']) ?>
                                                            &nbsp;<small class="<?= $Classname ?>"
                                                                style="text-decoration:line-through">₹<?php echo number_format($r_accessories[$i]['product_price']) ?></small>
                                                        </span>

                                                        <h4>
                                                            <?php echo $r_accessories[$i]['product_name'] ?>
                                                        </h4>
                                                        ...
                                                        <p class="d-flex wish-status">
                                                            <span class="d-flex align-items-center">
                                                                <?php
                                                                $stock = $r_accessories[$i]['quantity'];
                                                                if ($stock <= 0) { ?>
                                                        ...
                                                        if ($stock <= 0) { ?>
                                                            ...
                                                            <div>
                                                                <a class="btn-main buynow_btn"
                                                                    href="https://wa.me/7358992528?text=<?php echo urlencode("Product Information!\nProduct Name: " . $r_accessories[$i]['product_name'] . "\nProduct Price: " . $r_accessories[$i]['product_price']); ?>">Contact
                                                                    us to order</a>
                                                            </div>
                                                        ...
                                                        <?php } else { ?>
                                                            ...
                                                            <div>
                                                                <a class="btn-main buynow_btn"
                                                                    href="<?php echo base_url() ?>riding-details/<?php echo strtolower(str_replace(['/', ' '], '-', $r_accessories[$i]['redirect_url'])) ?>/<?php echo base64_encode($r_accessories[$i]['prod_id']) ?>">Buy
                                                                    Now</a>
                                                            </div>
                                                        <?php } ?>
            ...
            $(document).ready(function () {
                function filter_data() {
                    ...
                    `;
                        ...
                        <div>
                            <a class="btn-main buynow_btn"
                                href="${base_Url}riding-details/${product.redirect_url.toLowerCase().replace(/[/ ]/g, '-')}/${btoa(product.prod_id)}">
                                Buy Now
                            </a>
                        </div>
                    `;
                            ...
                            <div class="de-item">
                             ...
                             class="offer ${offerClass}">${offerDetails}%
                              ...
                              <a><span aria-hidden="true" class="icon_heart_alt wishlist-icon"
                                ...
                                $('.seach_results').html(searchResults); $(".wishlist-icon").on('click', function () {
        ...
        <script>
            $(document).on('click', '.view-more', function () {
                ...
                $.ajax({
                    method: 'POST',
                    url: base_Url + 'loadmore-ridingdetails',
