            ...
            <div class="container access_list_grid">
                <div class="row">
                    <h2 class="mb-4 text-center">
                        <?php echo strtoupper($product[0]->modal) ?>
                    </h2>
                    <!-- mobile view filter -->
                                    ...
                                    <div class="col-12 col-lg-3  productCard mb-4">
                                        <form>
                                            ...
                                            <div class="de-item">
                                                ...
                                                <span
                                                    class="offer  <?= $offerClass ?>"><?php echo $product[$i]->offer_details ?>%
                                                </span>
                                                <!-- wishlist  start -->
                                                ...
                                                <div class="d-img">
                                                    <a
                                                        href="<?php echo base_url() ?>accessories-detail/<?php echo strtolower(str_replace(' ', '-', $product[$i]->redirect_url)) ?>/<?php echo base64_encode($product[$i]->prod_id) ?>">
                                                        <img
                                                ...
                                                <div class="d-info">
                                                    <div class="d-text">
                                                        ...
                                                        <?php } else { ?>
                                                            ...
                                                            <div>
                                                                <a class="btn-main buynow_btn"
                                                                    href="<?php echo base_url() ?>accessories-detail/<?php echo strtolower(str_replace(' ', '-', $product[$i]->redirect_url)) ?>/<?php echo base64_encode($product[$i]->prod_id) ?>">Buy
                                                                    Now</a>
                                                            </div>
                                                        <?php } ?>
