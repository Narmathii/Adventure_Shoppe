                                            ...
                                            <div class="col-lg-12">
                                                <p class="offer_price">
                                                    ...
                                                    if ($offerType == 0 || $offerType == 1) { ?>
                                                        <span
                                                            class="m-0 price_span">₹<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $tour_detail['offer_price']) ?></span><span
                                                            class="real_price strike">
                                                            ₹<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $tour_detail['product_price']); ?></span>
                                                        <?php
                                                    } else { ?>
                                                        <span
                                                            class="m-0 price_span">₹<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $tour_detail['offer_price']) ?></span></span>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="tab-default">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                        ...
                                        <p class="m-0"><?php echo $tour_detail['prod_desc'] ?></p>
                                    </div>
                            ...
                            <div class="tab-default mt-3">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                        aria-labelledby="nav-home-tab">
                                        <p class="m-0"><?php echo $tour_detail['specifications'] ?></p>
                                    </div>
