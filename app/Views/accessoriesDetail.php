                            ...
                            <div class="de-box text-light">
                                <form name="contactForm" id='product-form' method="post">
                                    ...
                                    <div class="col-lg-12 block-with-text p-0">
                                        <span><?php echo $acc_details['prod_desc'] ?></span>
                                    </div>
                                    <div class='row'>
                                            ...
                                            <div class="col-lg-12">
                                                <p class="offer_price">
                                                    ...
                                                    if (($offerType ==  0 ) || ($offerType ==  1 )) {
                                                        ?>  
                                                        <span
                                                            class="m-0 price_span">₹<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $acc_details['offer_price']) ?></span><span
                                                            class="real_price strike">
                                                            ₹<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $acc_details['product_price']); ?></span>
                                                        <?php   
                                                    } else { ?>
                                                        <span
                                                            class="m-0 price_span">₹<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $acc_details['offer_price']) ?></span></span>
                            ...
                            <div class="tab-default">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                        ...
                                        <p class="m-0"><?php echo $acc_details['prod_desc'] ?></p>
                                    </div>
