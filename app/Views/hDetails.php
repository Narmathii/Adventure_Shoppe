...
<body onload="initialize()" class="dark-scheme">
    <div id="wrapper">
        ...
        <div class="no-bottom no-top zebra">
                            ...
                            <div id='slideshow-items-container'>
                                ...
                                ?>
                                    ...
                                    <input type="hidden" name="tbl_name" id="tbl_name"
                                        ...
                                        value="<?php echo $user_idd ?>" />
                                    <a><span aria-hidden="true" class="icon_heart_alt wishlist-btn"></span></a>
                                    <a><span aria-hidden="true" class="fas fa-share-alt share-btn" id="share-btn"></span></a>
                                </form>
                            </div>
                            <div id='result'></div>
                        </div>
                            ...
                            <div class="de-box text-light">
                                <form name="contactForm" id='product-form' method="post">
                                    ...
                                    <div class="col-lg-12 block-with-text p-0">
                                        <span><?php echo $h_details['prod_desc'] ?></span>
                                    </div>
                                    <div class='row'>
                                        ...
                                        <!-- <input type="hidden" name="color" id="color_val"
                                            ...
                                            value="<?php echo $h_details['size'][0] ?>" />
                                            ...
                                            <div class="col-lg-12">
                                                <p class="offer_price">
                                                    ...
                                                    if ($offerType == 0 || $offerType == 1) { ?>
                                                        <span
                                                            class="m-0 price_span">₹<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $h_details['offer_price']) ?></span><span
                                                            class="real_price strike">
                                                            ₹<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $h_details['product_price']); ?></span>
                                                        <?php
                                                    } else { ?>
                                                        <span
                                                            class="m-0 price_span">₹<?= preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $h_details['offer_price']) ?></span></span>
                                    ...
                                    <!-- For Quantity Update -->
                                    <input type="hidden" class="main-stock" value="<?= $h_details['quantity'] ?>" data-sizeval="<?= $countSize ?>">
            ...
            <!-- section begin -->
            <section aria-label="section" id=" py-0 details_section">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="tab-default">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                        ...
                                        <p class="m-0"><?php echo $h_details['prod_desc'] ?></p>
                                    </div>
                            ...
                            <div class="tab-default mt-3">
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                        aria-labelledby="nav-home-tab">
                                        <p class="m-0"><?php echo $h_details['specifications'] ?></p>
                                    </div>
                                        ...
                                        if ($offer == 1 || $offer == 2 || $offer == "" || $offer == 0 || $offer == "-") {
                                            ...
                                            <div class="d-info">
                                                ...
                                                <?php
                                                        ...
                                                        ?>
                                                <span
                                                    class="d-price">₹<?php echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $similar[$i]['offer_price']) ?>  &nbsp;<small class="<?= $Classname ?>"
                                    ...
                                    if (!in_array($similarProducts[$i]['prod_id'], $renderedProductIDs)) {
                                        ...
                                        if ($offer == 1 || $offer == 2 || $offer == "" || $offer == 0 || $offer == "-") {
                                            ...
                                            $offerClass = "";
                                                    ...
                                                    <span class="offer  <?= $offerClass ?>">
                                                        <?= $similarProducts[$i]['offer_details'] ?>%
                                                    </span>
                                                        <div class="d-img">
                                                        ...
                                                        ?>
                                                <span
                                                    class="d-price">₹<?php echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $similarProducts[$i]['offer_price']) ?>  &nbsp;<small class="<?= $Classname ?>"
                                    ...
                                    <a href="<?php echo $url; ?>">
                                        ...
                                        if ($offer == 1 || $offer == 2 || $offer == "" || $offer == 0 || $offer == "-") {
                                            ...
                                            $offerClass = "";
                                                ...
                                                <span class="offer  <?= $offerClass ?>">
                                                    <?= $recent_products[$i]['offer_details'] ?>%
                                                </span>
                                            ...
                                            <div class="d-info">
                                                ...
                                                <?php
                                                        ...
                                                        ?>
                                                <span
                                                    class="d-price">₹<?php echo preg_replace("/(\d+?)(?=(\d\d)+(\d)(?!\d))(\.\d+)?/i", "$1,", $recent_products[$i]['offer_price']) ?>  &nbsp;<small class="<?= $Classname ?>"
