        ...
        <section class="p-5">
            ...
            <div>
                ...
                <p>
                    ...
                    system.
                    Email marketing : With your permission, we may send you emails about our store, new products and
                    other updates.
                </p>
                ...
                <p>
                    ...
                    <br><br>
                    How do I withdraw my consent? If after you opt-in, you change your mind, you may withdraw your
                    consent for us to contact you, for the continued collection, use or disclosure of your information,
                    at any time, by contacting us at abhishek@adventureshoppe.com or mailing us at: Adventure Shopee,
                    Sri Saaraa Towers, 6-9, Dr. Balasundaram Rd, Coimbatore - 641018, Tamil Nadu, India.
                </p>
                ...
                <p>
                    ...
                    in a different jurisdiction than either you or us. So if you elect to proceed with a transaction
                    that involves the services of a third-party service provider, then your information may become
                    subject to the laws of the jurisdiction(s) in which that service provider or its facilities are
                    located.
                    <br><br>
                    ...
                    <br><br>
                    Links: When you click on links on our store, they may direct you away from our site. We are not
                ...
                <p>
                    ...
                    secure socket layer technology (SSL) and stored with AES-256 encryption. Although no method of
                ...
                <p>
                    Here is a list of cookies that we use. We’ve listed them here so you that you can choose if you want
                    to opt-out of cookies or not.
                <ul>
                    <li>_session_id, unique token, sessional, Allows Shopify to store information about your session
                        (referrer, landing page, etc).</li>
                    <li>_shopify_visit, no data held, Persistent for 30 minutes from the last visit, Used by our website
                        provider’s internal stats tracker to record the number of visits.</li>
                    <li>_shopify_uniq, no data held, expires midnight (relative to the visitor) of the next day, Counts
                        the number of visits to a store by a single customer.</li>
                    ...
                    <li>storefront_digest, unique token, indefinite, If the shop has a password, this is used to
                        determine if the current visitor has access.</li>
                </ul>
                </p>
                ...
                <h3>SECTION 8 - QUESTIONS AND CONTACT INFORMATION</h3>
                <p>
                    ...
                    abhishek@adventureshoppe.com or by mail at Adventure Shopee, [Re: Privacy Compliance Officer], Sri
                    Saaraa Towers, 6-9, Dr. Balasundaram Rd, Coimbatore - 641018, Tamil Nadu, India.
                </p>

                <h3>SECTION 9 - REFUNDS/CANCELLATIONS</h3>
                <p>
                    We offer refunds for products that are returned within 30 days of purchase in their original
                    condition. Once your return is received and inspected, we will send you an email to notify you of
                    the approval or rejection of your refund. If approved, your refund will be processed, and a credit
                    will automatically be applied to your credit card or original method of payment within 5-7 working
                    days.
                </p>

                <h3>SECTION 10 - PRICING</h3>
                <p>
                    All prices listed on our website are in INR (Indian Rupees) and are inclusive of applicable taxes.
                    Prices are subject to change without notice. We reserve the right to modify or discontinue a product
                    or service at any time.
                </p>

                <h3>SECTION 11 - SHIPPING POLICY</h3>
                <p>
                    We offer standard and expedited shipping options. Orders are typically processed within 1-2 business
                    days. Delivery times vary based on your location:
                <ul>
                    <li>Standard Shipping: 5-7 business days</li>
                    <li>Expedited Shipping: 2-4 business days</li>
                </ul>
                Shipping costs are calculated at checkout and are based on the weight and dimensions of your order as
                well as the shipping method chosen. Please note that shipping times are estimates and are not
                guaranteed. We are not responsible for delays caused by the shipping carrier.
                </p>
